...
{
    public class dashboardMetricDetail : AuthorizedServiceBase
    {
        [FunctionName("dashboardMetricsDetail")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "dashboardMetricsDetail")] HttpRequest req,
            ILogger log)
        {
            ...
            var rankings = DataUtility.CallSproc("[reports].[salonMetricsDetail]", sprocParams);
